...
def generate_datasets(language: str, sizes: List[int], exact_size: bool, output_directory: str):
    """
...
if __name__ == "__main__":
    ...
    generate_datasets(args.language, args.sizes, args.exact_size, args.output_dir)
